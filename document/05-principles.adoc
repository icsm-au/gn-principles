...
==== 2.5. Offshore places
* States and Territories are responsible for the naming of any feature within its legislated coastal watersfootnote:[https://www.legislation.gov.au/C2004A02276/latest/text[Coastal Waters (State Powers) Act 1980 (Cth)]] e.g. islands.
